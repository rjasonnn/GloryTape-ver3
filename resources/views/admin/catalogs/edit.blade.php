...
<main class="flex-1">
    <div class="py-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <form action="{{ route('catalogs.update', $catalog->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200">
                @csrf
                @method('PUT')
                @if ($errors->any())
                    ...
                    <div>
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1">
                                    <input type="date" name="start_date" id="start_date" value="{{ $catalog->start_date }}"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1">
                                    <input type="date" name="end_date" id="end_date" value="{{ $catalog->end_date }}"
                                           class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                </div>
                            </div>
                        </div>
